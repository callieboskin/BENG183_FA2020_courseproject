...
The euclidean distance is calculated as: d(p,q)= <img src="https://render.githubusercontent.com/render/math?math=\sqrt((p_1-q_1)^2\plus(p_2-q_2)^2\plus(…)\plus(p_n-q_n)^2)">.
